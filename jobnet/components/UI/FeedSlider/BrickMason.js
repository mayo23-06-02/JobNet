...
export default function BrickMason() {
    ...
    useEffect(() => {
        fetch('/api/auth')
            ...
            .then((data) => {
                ...
                const cleaners = data.filter(user => user.jobTitle === "Builder/Brick Mason");
    ...
    return (
        ...
        <p className='font-bold text-lg lg:text-2xl lg:py-4 py-2'>
